...
<body
    ...
    <main style="flex:1;position:relative;min-height:0;">
        ...
        {{-- DOCKING --}}
        <a href="{{ $scheme }}://project_cms.test/login?tenant=docking"
            style="position:absolute;inset:0;background:url('/Website_Slider.jpg') center/cover no-repeat;clip-path:polygon(0% 0%, 45.6% 0%, 15.2% 100%, 0% 100%);text-decoration:none;"
        ...
        {{-- NEW BUILDING --}}
        <a href="{{ $scheme }}://project_cms.test/login?tenant=new-building"
            style="position:absolute;inset:0;background:url('/Website_Slider.jpg') center/cover no-repeat;clip-path:polygon(47.2% 0%, 83.3% 0%, 52.9% 100%, 16.8% 100%);text-decoration:none;"
            onmouseover="this.style.background='linear-gradient(rgba(52,169,236,0.55),rgba(52,169,236,0.55)),url(/Website_Slider.jpg) center/cover no-repeat'"
            onmouseout="this.style.background='url(/Website_Slider.jpg) center/cover no-repeat'">
            <span
